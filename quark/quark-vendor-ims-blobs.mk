...
PRODUCT_COPY_FILES += \
    ...
    vendor/motorola/quark/proprietary/vendor/etc/diag_mdlog/Connection_Issues_V11.cfg:system/vendor/etc/diag_mdlog/Connection_Issues_V11.cfg \
    vendor/motorola/quark/proprietary/vendor/etc/diag_mdlog/default.cfg:system/vendor/etc/diag_mdlog/default.cfg \
    vendor/motorola/quark/proprietary/vendor/etc/diag_mdlog/default.opts:system/vendor/etc/diag_mdlog/default.opts \
    vendor/motorola/quark/proprietary/vendor/etc/diag_mdlog/FIT_V20_1.cfg:system/vendor/etc/diag_mdlog/FIT_V20_1.cfg \
    vendor/motorola/quark/proprietary/vendor/etc/diag_mdlog/FIT_V20_2_volte_full_ip.cfg:system/vendor/etc/diag_mdlog/FIT_V20_2_volte_full_ip.cfg \
    vendor/motorola/quark/proprietary/vendor/etc/diag_mdlog/Vzw_Connection_Issues_V2.cfg:system/vendor/etc/diag_mdlog/Vzw_Connection_Issues_V2.cfg \
